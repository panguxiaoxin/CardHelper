...
class AppCardCodeInjector {

    List<String> AppCardRootClassList

    AppCardCodeInjector(List<String> list) {
        AppCardRootClassList = list
    }
    ...
    void execute() {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (ScanUtil.REGISTER_CLASS_FILE_NAME == entryName) {
                ...
                ClassVisitor classVisitor = new AppCardClassVisitor(classWriter)
                //开始扫描class文件
    ...
    class AppCardClassVisitor extends ClassVisitor {
        AppCardClassVisitor(ClassVisitor classVisitor) {
        ...
        MethodVisitor visitMethod(int access, String name,
            ...
            if ("loadCardData" == name) {
                mv = new LoadAppCardMethodAdapter(mv, access, name, desc)
            }
            return mv
        }
    }

    class LoadAppCardMethodAdapter extends AdviceAdapter {

        LoadAppCardMethodAdapter(MethodVisitor mv, int access, String name, String desc) {
        ...
        protected void onMethodEnter() {
            ...
            appCardRootClassList.forEach({ proxyClassName ->
                ...
                mv.visitMethodInsn(INVOKESTATIC, "com/ryx/card_api/core/CardManager", "registerCardMeta", "(Ljava/lang/String;)V", false);
            })
        }
